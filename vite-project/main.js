...
const eugeneTexture = new THREE.TextureLoader().load('./imgs/eugene.jpg');

const eugene = new THREE.Mesh(new THREE.BoxGeometry(3, 3, 3), new THREE.MeshBasicMaterial({ map: eugeneTexture }));
